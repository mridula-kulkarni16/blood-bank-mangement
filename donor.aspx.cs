...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        sqlcon.Open();
        string cmdstr = "select * from usserrrss u1 full outer join dooonnrrr d2 on u1.id= d2.id";
...
protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
{
    if (e.CommandName.Equals("ADD"))
    {
        ...
        TextBox txtAdddonorname = (TextBox)GridView1.FooterRow.FindControl("txtAdddonorname");
        ...
        sqlcon.Open();
        string cmdstr = "insert into dooonnrrr(id,donorname, status,date) values(@id,@donorname,@status,@date)";
        SqlCommand cmd = new SqlCommand(cmdstr, sqlcon);
        cmd.Parameters.AddWithValue("@id", txtAddid.Text);
        cmd.Parameters.AddWithValue("@donorname", txtAdddonorname.Text);
...
protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
{
    Label lblid = (Label)GridView1.Rows[e.RowIndex].FindControl("lblid");
        sqlcon.Open();
        string cmdstr = "delete from dooonnrrr where id=@id";
        SqlCommand cmd = new SqlCommand(cmdstr, sqlcon);
...
protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
{
     Label lblEditid = (Label)GridView1.Rows[e.RowIndex].FindControl("lblEditid");
        TextBox txtEditdonorname = (TextBox)GridView1.Rows[e.RowIndex].FindControl("txtEditdonorname");
        ...
        sqlcon.Open();
        string cmdstr = "update dooonnrrr set donorname=@donorname,status=@status,date=@date where id=@id";
        SqlCommand cmd = new SqlCommand(cmdstr, sqlcon);
        cmd.Parameters.AddWithValue("@id", lblEditid.Text);
        cmd.Parameters.AddWithValue("@donorname", txtEditdonorname.Text);
