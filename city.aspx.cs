...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        sqlcon.Open();
        string cmdstr = "select * from cityyy";
...
protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
{
    if (e.CommandName.Equals("ADD"))
    {
        ...
        sqlcon.Open();
        string cmdstr = "insert into cityyy(id,username, state,city) values(@id,@username,@state,@city)";
        SqlCommand cmd = new SqlCommand(cmdstr, sqlcon);
...
protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
{
    Label lblid = (Label)GridView1.Rows[e.RowIndex].FindControl("lblid");
        sqlcon.Open();
        string cmdstr = "delete from cityyy where id=@id";
        SqlCommand cmd = new SqlCommand(cmdstr, sqlcon);
...
protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
{
     Label lblEditid = (Label)GridView1.Rows[e.RowIndex].FindControl("lblEditid");
        ...
        sqlcon.Open();
        string cmdstr = "update cityyy set username=@username,state=@state,city=@city where id=@id";
        SqlCommand cmd = new SqlCommand(cmdstr, sqlcon);
