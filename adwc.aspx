<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adwc.aspx.cs" Inherits="_adwc" %>
...
    <div style="height: 255px; width: 1110px;">
...
                </asp:Timer>
                    ...
                    <asp:Menu ID="Menu1" runat="server" BorderColor="White" DynamicHorizontalOffset="2" Font-Bold="True" Font-Names="Verdana" Font-Size="X-Large" ForeColor="#0033CC" Orientation="Horizontal" StaticSubMenuIndent="10px" style="position: relative">
                        ...
                        <Items>
                            ...
                            <asp:MenuItem Text="Manage user type" Value="Manage user type">
                                <asp:MenuItem NavigateUrl="~/patitent.aspx" Text="Patient" Value="Patient">
                                </asp:MenuItem>
                                <asp:MenuItem NavigateUrl="~/location.aspx" Text="Donor" Value="Donor"></asp:MenuItem>
                                <asp:MenuItem NavigateUrl="~/bloodbank.aspx" Text="BloodBank" Value="BloodBank"></asp:MenuItem>
                            </asp:MenuItem>
                            <asp:MenuItem NavigateUrl="~/admin.aspx" Text="Sign_In" Value="Sign_In">
                                ...
                                <asp:MenuItem NavigateUrl="~/admin.aspx" Text="Admin_Sign-In" Value="Admin_Sign-In"></asp:MenuItem>
                            </asp:MenuItem>
                        </Items>
                ...
                <p>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="#FF0066" Text="VIEW BY"></asp:Label>
                    &nbsp;</p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </ContentTemplate>
        </asp:UpdatePanel>
...
&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <p>
              ...
              <asp:Label ID="Label1" runat="server"  BorderStyle="None" Font-Bold="True" Font-Size="X-Large" Font-Names="Arial Black" Text="Welcome To Our Site" ForeColor="#CC0000" Height="31px" style="margin-left: 0px; margin-bottom: 78px" Width="449px"></asp:Label>
...
&nbsp;</li>
    <li>
        <asp:HyperLink ID="HyperLink20" runat="server" Font-Bold="True" ForeColor="#3333CC" NavigateUrl="http://www.massgeneral.org/neurology/assets/neuroDNAlab/genRequisitionForm.pdf">blood requisition and payment</asp:HyperLink>
    </li>
</ul>
<p>
    &nbsp;</p>
...
<p>
    &nbsp;</p>
<p>
    <asp:HyperLink ID="HyperLink17" runat="server" ForeColor="Red" NavigateUrl="https://blood.ca/sites/default/files/hospital_disposition_of_blood_components.pdf">Patitent req for blood components</asp:HyperLink>
</p>
<p>
...
<h2 class="page-title">
    <img id="SiteContent_Image1" alt="This page is secure" src="https://www.thebloodcenter.org/image/padlock.png" />Contact Uss</h2>
<p>
            ...
            <tr>
                <td align="left" valign="top">
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="vertical-align: top">
                        <tr>
                            <td valign="middle"><span id="ctl00_ContentPlaceHolder4_logo_lblHeader" class="HeaderCDSCO" title="CENTRAL DRUGS STANDARD CONTROL ORGANIZATION">CENTRAL DRUGS STANDARD CONTROL ORGANIZATION</span> </td>
                        </tr>
                        <tr>
